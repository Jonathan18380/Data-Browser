...
function insert(){
  let insertPokeman = new pokeman(document.getElementById('tname').value, document.getElementById('tcolor').value, document.getElementById('ttype').value, document.getElementById('tcomp').value, document.getElementById('theight'));
  ...
  httpRequest.open('GET', "http://localhost/mysite/project8/test.php?insertPokeman=" + inserts, true);
  httpRequest.send();
}
